...
public static class 
glTF_VCAST_vci_text_Serializer
{
...
public static void Serialize_vci_text_color(JsonFormatter f, Single[] value)
{
    f.BeginList();
...
public static void Serialize_vci_text_topLeftColor(JsonFormatter f, Single[] value)
{
    f.BeginList();
...
public static void Serialize_vci_text_topRightColor(JsonFormatter f, Single[] value)
{
    f.BeginList();
...
public static void Serialize_vci_text_bottomLeftColor(JsonFormatter f, Single[] value)
{
    f.BeginList();
...
public static void Serialize_vci_text_bottomRightColor(JsonFormatter f, Single[] value)
{
    f.BeginList();
...
public static void Serialize_vci_text_margin(JsonFormatter f, Single[] value)
{
    f.BeginList();
