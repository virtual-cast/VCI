...
public static class 
glTF_VCAST_vci_rigidbody_Deserializer
{
...
public static List<VCI.glTF_VCAST_vci_Rigidbody> glTF_VCAST_vci_rigidbody_Deserializevci_rigidbodies(JsonNode parsed)
{
    var value = new List<glTF_VCAST_vci_Rigidbody>();
