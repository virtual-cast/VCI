...
public static class 
glTF_VCAST_vci_joints_Deserializer
{
...
public static List<VCI.glTF_VCAST_vci_joint> glTF_VCAST_vci_joints_Deserializevci_joints(JsonNode parsed)
{
    var value = new List<glTF_VCAST_vci_joint>();
...
public static glTF_VCAST_vci_joint glTF_VCAST_vci_joints_Deserializevci_joints_ITEM(JsonNode parsed)
{
    var value = new glTF_VCAST_vci_joint();
...
public static Spring glTF_VCAST_vci_joints_Deserializevci_joints__spring(JsonNode parsed)
{
...
public static Limits glTF_VCAST_vci_joints_Deserializevci_joints__limits(JsonNode parsed)
{
    var value = new Limits();
