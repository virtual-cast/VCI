...
public static class 
glTF_VCAST_vci_material_unity_Deserializer
{
...
public static List<VCI.glTF_VCI_Material> glTF_VCAST_vci_material_unity_Deserializevci_materials(JsonNode parsed)
{
    var value = new List<glTF_VCI_Material>();
