...
public static class 
glTF_VCAST_vci_spring_bone_Deserializer
{
...
public static List<VCI.glTF_VCAST_vci_SpringBone> glTF_VCAST_vci_spring_bone_Deserializevci_springBones(JsonNode parsed)
{
    var value = new List<glTF_VCAST_vci_SpringBone>();
...
public static glTF_VCAST_vci_SpringBone glTF_VCAST_vci_spring_bone_Deserializevci_springBones_ITEM(JsonNode parsed)
{
    var value = new glTF_VCAST_vci_SpringBone();
