...
namespace VCI
{
    ...
    public class glTF_VCI_Material : JsonSerializableBase
    {
        public string name;
        ...
        public static List<glTF_VCI_Material> Parse(string src)
        {
        ...
        public static glTF_VCI_Material CreateFromMaterial(Material m, List<Texture> textures)
        {
            ...
            {
                foreach (var keyword in m.shaderKeywords) material.keywordMap.Add(keyword, m.IsKeywordEnabled(keyword));
            ...
            foreach (var tag in TAGS)
            {
                ...
                if (!String.IsNullOrEmpty(value)) material.tagMap.Add(tag, value);
            }
