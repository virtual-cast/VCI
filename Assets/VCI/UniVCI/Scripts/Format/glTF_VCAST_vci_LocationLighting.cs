...
{
    [Serializable]
    public sealed class glTF_VCAST_vci_LocationLighting
    {
        ...
        /// </summary>
        public glTFLightmapTextureInfo[] lightmapTextures = new glTFLightmapTextureInfo[0];

        /// <summary>
        /// このロケーション VCI のスカイボックスのキューブマップ
        /// </summary>
        public glTFCubemapTexture skyboxCubemap = new glTFCubemapTexture();

        /// <summary>
        /// このロケーション VCI の LightProbe 集合
        /// </summary>
        public glTF_VCAST_vci_LocationLighting_LightProbe[] lightProbes;
