...
namespace VCI
{
    ...
    /// </summary>
    public sealed class EditorAnimationNodeExporter : IVciAnimationNodeExporter
    {
        public IAnimationExporter GltfRootAnimationExporter { get; } = new EditorAnimationExporter();
        ...
        public List<(glTFNode, glTF_VCAST_vci_animation)> ExportAnimations(ExportingGltfData exportingData, GameObject root, List<Transform> nodes)
        {
            ...
            {
                // NOTE: No support at Runtime
                return animationExtensions;
            }

            // NOTE: Root Animation は glTF の Exporter が処理する.
