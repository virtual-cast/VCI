...
namespace VCI
{
    public sealed class UnitySettingsLayerValidator : IUnitySettingsValidator
    {
        ...
        {
            VciColliderSetting.VciColliderLayers[VciColliderSetting.VciColliderLayerTypes.Location],
            VciColliderSetting.VciColliderLayers[VciColliderSetting.VciColliderLayerTypes.PickUp],
            VciColliderSetting.VciColliderLayers[VciColliderSetting.VciColliderLayerTypes.Accessory],
            VciColliderSetting.VciColliderLayers[VciColliderSetting.VciColliderLayerTypes.Item],
        };
