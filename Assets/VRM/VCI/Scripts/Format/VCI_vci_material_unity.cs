...
{
    [Serializable]
    [JsonSchema(Title = "vci.material")]
    public class UnityMaterial : JsonSerializableBase
    {
        public string name;
        ...
        private static readonly string[] VCIExtensionShaders = new string[]
        {
            "VRM/MToon"
        };

        private static readonly string VCI_USE_GLTFSHADER = "VCI_USE_GLTFSHADER";
        ...
        public static List<UnityMaterial> Parse(string src)
        {
        ...
        public static List<UnityMaterial> Parse(ListTreeNode<JsonValue> json)
        {
            var materials = json.DeserializeList<UnityMaterial>();
        ...
        public static UnityMaterial CreateFromMaterial(Material m, List<Texture> textures)
        {
            var material = new UnityMaterial
            {
                name = m.name,
            ...
            if (!VCIExtensionShaders.Contains(m.shader.name))
            {
                material.shader = VCI_USE_GLTFSHADER;
                return material;
            }
